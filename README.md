...
The application runs fully offline. It does not use cloud services, proprietary APIs, or paid services. Optional Ollama extraction talks only to a user-provided local Ollama server.
...
| Future integrations | `pdf_manager/integrations/` | Placeholder interfaces for Docling and agent workflows. |
...
|---|---|---|---|---|
| Docling | Document extraction and structured PDF processing | Placeholder only | Verify before use | https://www.docling.ai/ |
...
- Docling extraction and agent workflow execution are not implemented yet.
